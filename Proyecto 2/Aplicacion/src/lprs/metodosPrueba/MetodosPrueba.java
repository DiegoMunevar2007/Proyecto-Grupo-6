...
// Usuario usuarioI = lprs.getManejadorSesion().iniciarSesion(usuario,
// contrasenia);
...
// String idLP = profesorIniciado1.crearLearningPath("Titulo learning path",
...
// String idLP2 = profesorIniciado2.crearLearningPath("Titulo learning path 2",
// "Descripcion 2", "Principiante",
// objetivos2);
...
// lP.crearTarea("Tarea 1", "Descripcion de tarea 1", "Objetivo de tarea 1", 10,
// false, lP.obtenerFecha());
// Tarea tarea2 = lP.crearTarea("Tarea 2", "Descripcion de tarea 2", "Objetivo
// de tarea 2", 10, true,
// lP.obtenerFecha());
// tarea2.crearSeccion(1, "Seccion 1", "Descripcion de seccion 1", "Objetivo de
// seccion 1",
// "Contenido de seccion 1",
// "Ejemplo de seccion 1", "Explicacion de seccion 1", "Pista de seccion 1",
// "Resultado esperado de seccion 1");

// Tarea tarea3 = lP.crearTarea("Tarea 3", "Descripcion de tarea 3", "Objetivo
// de tarea 3", 10, false,
// lP.obtenerFecha());
...
// lP.crearRecursoEducativo("Recurso 1", "Descripcion del recurso", "Objetivo
// del recurso", 20, false,
// lP.obtenerFecha(), "Video", "youtube.com");

// Encuesta encuesta = lP.crearEncuesta("Encuesta 1", "Descripcion de encuesta
// 1", "Objetivo de encuesta 1", 10,
// true,
// lP.obtenerFecha());
// encuesta.addPreguntaEncuesta(new PreguntaAbierta("Enunciado de una pregunta
// abierta de la encuesta 1 "));

// QuizMultiple quiz = lP.crearQuizMultiple("Quiz 1", "Descripcion de quiz 1",
// "Objetivo de quiz 1", 10, false, lP.obtenerFecha(),
// 20);
...
// lP.obtenerFecha());
// examen.addPreguntaExamen(new PreguntaAbierta("Enunciado de una pregunta
// abierta del examen 1"));
...
// LearningPath lP = profesorIniciado1.getLearningPathCreado("0");
// try {
// lP.editarLearningPath("Titulo modificado", "Descripcion modificada",
// "Principiante",
...
// Resenia resenia = new Resenia(profesorIniciado1, "Resenia de la actividad",
// 5);
...
// System.out.println("----------------------");
// Resenia reseniaLP = new Resenia(profesorIniciado2, "Resenia de la actividad
// pero por profe 2", 4);
...
// estudianteIniciado.obtenerAvance("0").getActividadesPendientes();
...
// ArrayList<Actividad> actividades =
// avanceEstudiante.getActividadesCompletadasLista();
// Actividad actividadBase = actividades.get(0);
// actividadBase.addResenia(new Resenia(estudianteIniciado, "Buena actividad",
// 5));
...
// ArrayList<ActividadRealizable> actividadesPendientes =
// profesorIniciado1.getActividadesPendientes();
...
// profesorIniciado1.getLearningPathsCreadosLista();
